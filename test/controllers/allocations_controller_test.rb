...
class AllocationsControllerTest < ActionController::TestCase
  ...
  test "should create allocation" do
    assert_difference('Allocation.count') do
      post :create, allocation: { balcao: @allocation.balcao, grupo_analise_id: @allocation.grupo_analise_id, number: @allocation.number, priority: @allocation.priority, ruleTipe: @allocation.ruleTipe }
    end
  ...
  test "should update allocation" do
    patch :update, id: @allocation, allocation: { balcao: @allocation.balcao, grupo_analise_id: @allocation.grupo_analise_id, number: @allocation.number, priority: @allocation.priority, ruleTipe: @allocation.ruleTipe }
    assert_redirected_to allocation_path(assigns(:allocation))
  end
